...
build/cloxc : build/cloxc.o build/asm.o build/value.o build/compiler.o
	$(CC) build/cloxc.o build/asm.o build/value.o build/compiler.o -o build/cloxc

build/cloxc.o : src/cloxc.c src/include/common.h src/include/asm.h src/include/value.h 
	$(CC) -c src/cloxc.c -o build/cloxc.o

build/compiler.o : src/compiler.c src/include/common.h src/include/asm.h src/include/value.h 
	$(CC) -c src/compiler.c -o build/compiler.o
